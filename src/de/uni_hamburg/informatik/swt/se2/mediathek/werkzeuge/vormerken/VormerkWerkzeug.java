...
public class VormerkWerkzeug
{
    ...
    private boolean istVormerkenMoeglich()
    {
        ...
        boolean vormerkenMoeglich = (kunde != null)
                                    && !medien.isEmpty()
                                    && _verleihService.istVormerkenFuerAlleMoeglich(kunde, medien);
    ...
    private void merkeAusgewaehlteMedienVor()
    {
        ...
        _verleihService.merkeAusgewaehlteMedienVor(selectedKunde, selectedMedien, heute);
    }
