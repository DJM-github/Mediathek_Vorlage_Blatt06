...
public class VormerkMedienauflisterWerkzeug extends ObservableSubWerkzeug
{
    ...
    private void setzeAnzuzeigendeMedien()
    {
        ...
        for (Medium medium : medienListe)
        {
            ...
            List<Vormerkkarte> MedienVormerkListe = _verleihService.zeigeVormerkkartenFuer(medium);
            switch (MedienVormerkListe.size())
            {
            case 1:
                vormerker1=MedienVormerkListe.get(0).getVormerker();
                break;
            case 2:
                vormerker1=MedienVormerkListe.get(0).getVormerker();
                vormerker2=MedienVormerkListe.get(1).getVormerker();
                break;
            case 3:
                vormerker1=MedienVormerkListe.get(0).getVormerker();
                vormerker2=MedienVormerkListe.get(1).getVormerker();
                vormerker3=MedienVormerkListe.get(2).getVormerker();
                break;
            default:
                break;
            }          
